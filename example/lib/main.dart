                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          colorBlock("${color.name.toLowerCase()}A", color.accent,
                              bg: color.name == "White" ? Colors.black : null),
                          colorBlock(
...
List<_ColorsDemo> colorMap() {
  return [
    ...
    _ColorsDemo(
      name: "White",
      primary: RadixColors.white,
      accent: RadixColors.whiteA,
      primaryDark: RadixColors.dark.white,
      accentDark: RadixColors.dark.whiteA,
    ),
    _ColorsDemo(
      name: "Black",
      primary: RadixColors.black,
      accent: RadixColors.blackA,
      primaryDark: RadixColors.dark.black,
      accentDark: RadixColors.dark.blackA,
    ),
  ];
}
